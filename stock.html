...
<body>
  ...
  <div id="printArea" style="display:none;">
    <h2 style="text-align:center;">📦 รายงานสต๊อกอุปกรณ์ทั่วไป</h2>
  ...
  function addItem() {
    ...
    const unit = prompt("หน่วย:", "ชิ้น");
    const loc = prompt("ตำแหน่ง / ห้องสโตร์:", "สโตร์กลาง");
